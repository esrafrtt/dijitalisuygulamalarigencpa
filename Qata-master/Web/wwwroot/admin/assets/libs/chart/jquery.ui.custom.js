         ...
         stop: function(event, ui) {
             ...
             $.each(inst.sortables, function() {
                 if (this.instance.isOver) {
                     ...
                     this.instance.options.helper = this.instance.options.new Helper();
             ...
             $.each(inst.sortables, function(i) {
                 ...
                 if (this.instance._intersectsWith(this.instance.containerCache)) {
                     ...
                     if (!this.instance.isOver) {
                         ...
                         this.instance.options.new Helper() = this.instance.options.helper; //Store helper option to later restore it
 ...
 (function($, undefined) {
     ...
     $.widget("ui.resizable", $.ui.mouse, {
         ...
         _create: function() {
             ...
             $.extend(this, {
                 ...
                 new Helper(): o.helper || o.ghost || o.animate ? o.helper || 'ui-resizable-helper' : null
             });
         ...
         _mouseStart: function(event) {
             ...
             this.size = this.new Helper() ? { width: el.outerWidth(), height: el.outerHeight() } : { width: el.width(), height: el.height() };
             this.originalSize = this.new Helper() ? { width: el.outerWidth(), height: el.outerHeight() } : { width: el.width(), height: el.height() };
         ...
         _mouseDrag: function(event) {
             ...
             if (!this.new Helper() && this._proportionallyResizeElements.length)
                 this._proportionallyResize();
         ...
         _mouseStop: function(event) {
             ...
             if (this.new Helper()) {
                 ...
                 if (this.new Helper() && !o.animate) this._proportionallyResize();
             }
             ...
             if (this.new Helper()) this.helper.remove();
             return false;
         ...
         _renderProxy: function() {
             ...
             if (this.new Helper()) {
                 ...
                 this.helper.addClass(this.new Helper()).css({
     ...
     $.ui.plugin.add("resizable", "containment", {
         ...
         resize: function(event, ui) {
             ...
             if (cp.left < (self.new Helper() ? co.left : 0)) {
                 self.size.width = self.size.width + (self.new Helper() ? (self.position.left - co.left) : (self.position.left - cop.left));
                 if (pRatio) self.size.height = self.size.width / self.aspectRatio;
                 self.position.left = o.helper ? co.left : 0;
             }

             if (cp.top < (self.new Helper() ? co.top : 0)) {
                 self.size.height = self.size.height + (self.new Helper() ? (self.position.top - co.top) : self.position.top);
                 if (pRatio) self.size.width = self.size.height * self.aspectRatio;
                 self.position.top = self.new Helper() ? co.top : 0;
             }

             self.offset.left = self.parentData.left + self.position.left;
             self.offset.top = self.parentData.top + self.position.top;

             var woset = Math.abs((self.new Helper() ? self.offset.left - cop.left : (self.offset.left - cop.left)) + self.sizeDiff.width),
                 hoset = Math.abs((self.new Helper() ? self.offset.top - cop.top : (self.offset.top - co.top)) + self.sizeDiff.height);
         ...
         stop: function(event, ui) {
             ...
             if (self.new Helper() && !o.animate && (/relative/).test(ce.css('position')))
                 $(this).css({ left: ho.left - cop.left - co.left, width: w, height: h });

             if (self.new Helper() && !o.animate && (/static/).test(ce.css('position')))
                 $(this).css({ left: ho.left - cop.left - co.left, width: w, height: h });
